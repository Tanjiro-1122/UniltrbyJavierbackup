...
import { ChevronLeft, BookOpen, PenLine } from "lucide-react";
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 gap-6">
        ...
        >
          ...
          <div>
            <p className="text-white font-bold text-lg">New Entry</p>
            <p className="text-white/40 text-sm">Write what's on your mind today</p>
          </div>
        </motion.button>
