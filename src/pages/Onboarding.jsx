      ...
      <div className="relative z-10 flex-1 min-h-0">
        <AnimatePresence mode="wait">
          ...
          {step === 0 && (
            ...
            >
              <h2 className="text-3xl font-black text-white mb-2" style={{ textShadow: "0 0 20px rgba(168,85,247,0.5)" }}>
                {STEP_TITLES[0]}
              </h2>
          ...
          {step === 1 && (
            <motion.div
              key="step1"
              initial={{ opacity: 0, x: 60 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -60 }}
              className="absolute inset-0 flex flex-col px-4 pt-2 overflow-hidden"
            >
              <h2 className="text-3xl font-black text-white mb-1 shrink-0" style={{ textShadow: "0 0 20px rgba(168,85,247,0.5)" }}>
                Pick your companion
              </h2>
                  ...
                  {COMPANIONS.map((c) => (
                    <motion.button
                      ...
                      style={{
                        ...
                        border: selectedCompanion === c.id ? "2px solid rgba(168,85,247,0.85)" : "2px solid rgba(255,255,255,0.08)",
                    ...
                    >
                      ...
                      <p className="text-white text-xs font-bold mt-1.5 text-center leading-tight">{c.emoji} {c.name}</p>
                      <p className="text-white/40 text-[10px] text-center leading-tight mt-0.5 px-1">{c.tagline}</p>
                    </motion.button>
                  ))}
                </div>
              </div>
          ...
          {step === 3 && (
            <motion.div
              ...
              className="absolute inset-0 flex flex-col px-4 pt-2 overflow-hidden"
            >
              <h2 className="text-3xl font-black text-white mb-2 shrink-0" style={{ textShadow: "0 0 20px rgba(168,85,247,0.5)" }}>
                {STEP_TITLES[3]}
              </h2>
                ...
                <div className="grid grid-cols-2 gap-3 pb-4">
                  {BACKGROUNDS.map((bg) => (
                    <motion.button
                      ...
                      style={{
                        border: selectedBackground === bg.id ? "2px solid rgba(168,85,247,0.9)" : "2px solid rgba(255,255,255,0.1)",
      ...
      <div className="sticky-bottom relative z-10">
        ...
        >
          {step === 3
            ...
            : <span>Next <ChevronRight className="inline w-4 h-4" /></span>
          }
        </button>
      </div>
    </div>
